...
<section
	id="skills"
	class="relative flex h-full min-h-[75vh] w-full items-center justify-center bg-custom-white-theme dark:bg-[#2a374a] sm:min-h-[100vh] md:min-h-[60vh] xl:min-h-[50vh]"
>
